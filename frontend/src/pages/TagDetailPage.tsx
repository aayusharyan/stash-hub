// Tag detail page. Shows the tag name, alias list, sub-tag list,
...
import { useScenes, useTag } from "@/lib/queries";
      ...
      >
        <div className="mx-auto w-full max-w-screen-2xl px-3 md:px-6">
          <div className="py-8 flex flex-col sm:flex-row items-start gap-6">
            {/* Tag logo box - shows the tag image or a fallback icon */}
            <div
              className="flex-shrink-0 rounded flex items-center justify-center overflow-hidden"
              style={{ width: 80, height: 80, backgroundColor: "var(--bg-secondary)", border: "1px solid var(--border)" }}
            >
