  ...
  if (!studio) {
    return (
      <div className="flex flex-col items-center justify-center h-96" style={{ color: "var(--text-muted)" }}>
        ...
        <Link to="/studios" style={{ color: "var(--primary)" }}>← Back to studios</Link>
      </div>
    );
  }
          ...
          <div className="py-8 flex flex-col sm:flex-row items-start gap-6">
            ...
            <div
              ...
              style={{
                width: 160,
                height: 80,
                backgroundColor: studio.image_path && !imgError ? "#1a1a1a" : "var(--bg-secondary)",
            ...
            >
              {studio.image_path && !imgError ? (
                ...
                <span className="text-sm font-bold text-center px-2" style={{ color: "var(--text-muted)" }}>
                  {studio.name}
                </span>
              )}
            </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {studio.parent_studio && (
                <p className="mt-1 text-sm">
                  ...
                  <Link to={`/studios/${studio.parent_studio.id}`} style={{ color: "var(--primary)" }}>
          ...
          <section className="mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              {studio.child_studios.map((sub) => (
                ...
                >
                  {sub.image_path && (
                    <img src={toProxyUrl(sub.image_path)!} alt={sub.name} className="object-contain" style={{ maxWidth: 32, maxHeight: 16 }} />
                  )}
