...
export function PerformerCard({ performer, className }: Props) {
  ...
  return (
    <Link to={`/performers/${performer.id}`} className={cn("group block text-center", className)}>
      {/* Avatar */}
      <div
      ...
      >
        ...
        >
          <div className="w-full p-2">
            <p className="text-xs font-semibold text-primary">{performer.scene_count} videos</p>
          </div>
        </div>
      </div>
